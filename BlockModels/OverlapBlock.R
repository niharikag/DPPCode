...
gen.data.overlap = function(p, n, true.beta, err.sigma)
{
  Z1 = rnorm(n)
  Z2 = rnorm(n)
  Z3 = rnorm(n)
...
iterate.overlap = function(iter)
{
  ...
  for(index in 1:iter)
  {
    d = gen.data.overlap(p, n, true.beta, err.sigma)
